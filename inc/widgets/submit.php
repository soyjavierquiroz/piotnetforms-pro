...
class Piotnetforms_Submit extends Base_Widget_Piotnetforms {
	...
	public function register_controls() {
        ...
        $this->start_section( 'razorpay_settings_section', 'Razorpay' );
		$this->add_razorpay_setting_controls();
        $this->start_section( 'razorpay_sub_settings_section', 'Razorpay Subscription' );
		$this->add_razorpay_sub_setting_controls();
	...
	private function add_other_options_controls() {
        ...
        $this->add_control(
			'check_email_exists',
			[
				'label'        => __( 'Check Email Exists In Database?', 'piotnetforms' ),
				'type'         => 'switch',
        ...
        $this->add_control(
			'check_email_exists_for',
			[
				'label'       => __( 'Scope', 'piotnetforms' ),
				'type'        => 'select',
				'options'     => [
                    'this-form' => __( 'This Form', 'piotnetforms' ),
                    'all-form' => __( 'All Form', 'piotnetforms' ),
                ],
				'value'       => 'this-form',
                'condition' => [
        ...
        $this->add_control(
			'email_exists_notification',
			[
				'label'       => __( 'Notice of duplicate email', 'piotnetforms' ),
				'type'        => 'text',
				'value'       => 'Email [email] already exists.',
                'description' => 'The [email] will be replaced by customer email.',
                'condition' => [
                    'check_email_exists' => 'true'
                ],
                'label_block' => true
    ...
    private function add_razorpay_setting_controls() {
        if ( empty( get_option( 'piotnetforms-razorpay-key-id' ) ) || empty( get_option('piotnetforms-razorpay-key-secret') ) ) {
			$this->add_control(
				'razorpay_note',
				[
					'type'    => 'html',
					'raw'     => '<p>Please enter Razorpay API Key at Dashboard->Piotnet Forms->Settings->Integration->Razorpay Integration</p>',
				]
			);
		} else {
			$this->add_control(
            ...
            $this->add_control(
				...
				[
					'label'        => __( 'Partial Payment?', 'piotnetforms' ),
					'type'         => 'switch',
					'default'      => '',
					'label_on'     => 'Yes',
					'label_off'    => 'No',
            ...
            $this->add_control(
				...
				[
					'label'       => __( 'First Payment Min Amount', 'piotnetforms' ),
					'type'        => 'text',
					'description' => __( 'Minimum amount that must be paid by the customer as the first partial payment.', 'piotnetforms' ),
                    'dynamic'     => true,
				    'get_fields'  => true,
					'condition'   => [
						'razorpay_enable' => 'yes',
            ...
            $this->add_control(
				...
				[
					...
					'type'        => 'text',
					'description' => __( 'The business name shown on the Checkout form. For example, Acme Corp.', 'piotnetforms' ),
					'condition'   => [
						'razorpay_enable' => 'yes',
					],
				]
            ...
            $this->add_control(
				...
				[
					'label'       => __( 'Description', 'piotnetforms' ),
					'type'        => 'text',
					'description' => __( 'E.g Piotnet Addons, [field id="description"]', 'piotnetforms' ),
                    'dynamic'     => true,
				    'get_fields'  => true,
					'condition'   => [
						'razorpay_enable' => 'yes',
            ...
            $this->add_control(
				'razorpay_image',
				[
					'label'       => __( 'Image', 'piotnetforms' ),
					'type'        => 'text',
					'description' => __( 'ink to an image (usually your business logo) shown on the Checkout form.', 'piotnetforms' ),
					'condition'   => [
						'razorpay_enable' => 'yes',
					],
				]
            ...
            $this->add_control(
				...
				[
					'label'       => __( 'Customer Name', 'piotnetforms' ),
					'type'        => 'text',
                    'dynamic'     => true,
				    'get_fields'  => true,
					'condition'   => [
            ...
            $this->add_control(
				...
				[
					'label'       => __( 'Customer Email', 'piotnetforms' ),
					'type'        => 'text',
                    'dynamic'     => true,
				    'get_fields'  => true,
					'condition'   => [
            ...
            $this->add_control(
				...
				[
					'label'       => __( 'Customer Phone', 'piotnetforms' ),
					'type'        => 'text',
                    'dynamic'     => true,
				    'get_fields'  => true,
					'condition'   => [
            ...
            $this->add_control(
                ...
                [
                    'type'           => 'repeater',
                    'label'          => __( 'Note List', 'piotnetforms' ),
                    'value'          => '',
                    'label_block'    => true,
                    'add_label'      => __( 'Add Item', 'piotnetforms' ),
                    'controls'       => $repeater_list,
            ...
            $this->add_control(
				'razorpay_message_succeeded',
				[
					'label'       => __( 'Succeeded Message', 'piotnetforms' ),
					'type'        => 'text',
                    'value' => __( 'Payment success', 'pafe' ),
					'condition'   => [
						'razorpay_enable' => 'yes',
					],
				]
            ...
            $this->add_control(
				'razorpay_message_failed',
				[
					'label'       => __( 'Failed Message', 'piotnetforms' ),
					'type'        => 'text',
                    'value' => __( 'Payment failed', 'pafe' ),
					'condition'   => [
						'razorpay_enable' => 'yes',
					],
				]
    ...
    private function add_razorpay_sub_setting_controls() {
        if ( empty( get_option( 'piotnetforms-razorpay-key-id' ) ) || empty( get_option('piotnetforms-razorpay-key-secret') ) ) {
			$this->add_control(
				'razorpay_sub_note',
				[
            ...
            $this->add_control(
				...
				[
					'type'    => 'html',
					'raw'     => '<div><div style="text-align:center;"><button data-piotnetforms-razor-sub-get-plan class="piotnetforms-admin-button-ajax piotnetforms-button piotnetforms-button-default" type="button">Get Plans&ensp;<i class="fas fa-spinner fa-spin"></i></button></div><div class="piotnetforms-razor-get-plan-result" style="margin-top: 5px;"></div></div>',
                    'condition'   => [
            ...
            $this->add_control(
				...
				[
					'label'       => __( 'Total Count', 'piotnetforms' ),
					'type'        => 'text',
					'description' => __( 'The number of billing cycles for which the customer should be charged.', 'piotnetforms' ),
                    'dynamic'     => true,
				    'get_fields'  => true,
					'condition'   => [
						'razorpay_sub_enable' => 'yes',
            ...
            $this->add_control(
				...
				[
					...
					'type'        => 'text',
					'description' => __( 'The number of times the customer should be charged the plan amount per invoice.', 'piotnetforms' ),
                    'dynamic'     => true,
				    'get_fields'  => true,
					'condition'   => [
						'razorpay_sub_enable' => 'yes',
            ...
            $this->add_control(
				'razorpay_sub_message_succeeded',
				[
					'label'       => __( 'Succeeded Message', 'piotnetforms' ),
					'type'        => 'text',
                    'value' => __( 'Subscription success.', 'pafe' ),
					'condition'   => [
						'razorpay_sub_enable' => 'yes',
					],
				]
            ...
            $this->add_control(
				'razorpay_sub_message_failed',
				[
					'label'       => __( 'Failed Message', 'piotnetforms' ),
					'type'        => 'text',
                    'value' => __( 'Subscription failed.', 'pafe' ),
					'condition'   => [
						'razorpay_sub_enable' => 'yes',
					],
				]
	...
	private function add_email_setting_controls() {
        ...
        $this->add_control(
			'enable_attachment_default_email',
			[
				'label' => __( 'Default attachment?', 'piotnetforms' ),
				'type' => 'switch',
				'default' => '',
				'label_on' => 'Yes',
				'label_off' => 'No',
        ...
        $this->add_control(
			...
			[
				'label'       => __( 'Attachment URL', 'piotnetforms' ),
				'type'        => 'text',
				'value'       => '',
                'label_block' => true,
				'description' => __( 'Separate files with commas', 'piotnetforms' ),
				'render_type' => 'none',
                'condition' => [
                    'enable_attachment_default_email' => 'yes'
                ]
			]
		);
	...
	private function add_email_2_setting_controls() {
        ...
        $this->add_control(
			'enable_attachment_default_email2',
			[
				'label' => __( 'Default attachment?', 'piotnetforms' ),
				'type' => 'switch',
				'default' => '',
	...
	private function add_sendinblue_setting_controls() {
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Update Contact?', 'piotnetforms' ),
				'type' => 'switch',
				'label_on' => __( 'Yes', 'piotnetforms' ),
				'label_off' => __( 'No', 'piotnetforms' ),
				'return_value' => 'yes',
	...
	private function add_pdfgenerator_setting_controls() {
        ...
        $this->add_control(
			'pdf_remove_signature',
			[
				'label'        => __( 'Remove files after mapping', 'piotnetforms' ),
				'type'         => 'switch',
				'label_on'     => __( 'Yes', 'piotnetforms' ),
				'label_off'    => __( 'No', 'piotnetforms' ),
				'return_value' => 'yes',
	...
	private function add_twilio_sendgrid_setting_controls() {
        ...
        $this->add_control(
			'twilio_sendgrid_get_field',
			[
				'type' => 'html',
				  'label_block' => true,
				'raw' => __( '<button data-piotnetforms-twilio-sendgrid-get-field class="piotnetforms-admin-button-ajax elementor-button elementor-button-default" type="button">Get Field Map&ensp;<i class="fas fa-spinner fa-spin"></i></button><br><div data-piotnetforms-twilio-sendgrid-get-field-results></div>', 'piotnetforms' ),
			]
		);
	...
	private function add_whatsapp_setting_controls() {
		$this->add_control(
			...
			[
				...
				'type' => 'text',
				'description' => __( 'Phone with country code, like: +14155238886<br>You can send to multiple phone numbers, separated by commas.', 'piotnetforms' ),
			]
		);
	...
	public function render() {
		...
		if ( $form_id ) {
            ...
            if(!empty($settings['razorpay_enable'])) {
                $this->add_render_attribute( 'button', 'data-piotnetforms-razor-payment', 'yes' );
            }
            if(!empty($settings['razorpay_sub_enable'])) {
                $this->add_render_attribute( 'button', 'data-piotnetforms-razorpay-sub', 'yes' );
            }
            if(!empty($settings['advanced_custom_id_button'])){
                $this->add_render_attribute( 'button', 'id', $settings['advanced_custom_id_button'] );
            }
            if(!empty($settings['advanced_custom_classes_button'])){
                $this->add_render_attribute( 'button', 'class', $settings['advanced_custom_classes_button'] );
            }
		    ...
		    <script>
		    	function getFieldValue(string, replace) {
					...
					if (fieldType == 'radio' || fieldType == 'checkbox') {
                        let fieldCheck = $field.closest('.piotnetforms-field-group').find('input:checked');
                        ...
                        let dataLabel = fieldCheck.attr('data-piotnetforms-send-data-by-label');
	    ...
	    <?php endif; ?>
        <?php
            if(!empty($settings['razorpay_enable']) || !empty($settings['razorpay_sub_enable'])){
                echo '<script src="https://checkout.razorpay.com/v1/checkout.js"></script>';
            }
        ?>
		<?php  if(!empty($settings['razorpay_enable'])):
            $razorpay_success = !empty($settings['razorpay_message_succeeded']) ? $settings['razorpay_message_succeeded'] : 'Payment success.';
            $razorpay_failed = !empty($settings['razorpay_message_failed']) ? $settings['razorpay_message_failed'] :'Payment failed.';
            ?>
            <div class="piotnetforms-alert piotnetforms-alert--razor">
				<div class="piotnetforms-message piotnetforms-message-success" role="alert"><?php echo $razorpay_success; ?></div>
				<div class="piotnetforms-message piotnetforms-message-danger" role="alert"><?php echo $razorpay_failed; ?></div>
			</div>
        <?php endif; ?>
        <?php  if(!empty($settings['razorpay_sub_enable'])):
            $razorpay_sub_success = !empty($settings['razorpay_message_succeeded']) ? $settings['razorpay_sub_message_succeeded'] : 'Subscription success.';
            $razorpay_sub_failed = !empty($settings['razorpay_message_failed']) ? $settings['razorpay_sub_message_failed'] :'Subscription failed.';
            ?>
            <div class="piotnetforms-alert piotnetforms-alert--razor-sub">
				<div class="piotnetforms-message piotnetforms-message-success" role="alert"><?php echo $razorpay_sub_success; ?></div>
				<div class="piotnetforms-message piotnetforms-message-danger" role="alert"><?php echo $razorpay_sub_failed; ?></div>
			</div>
        <?php endif; ?>
	...
	public function live_preview() {
		...
		<%	
            ...
            if(s.advanced_custom_classes_button){
                view.add_attribute( 'button', 'class', s.advanced_custom_classes_button );
            }
            if(s.advanced_custom_id_button){
                view.add_attribute( 'button', 'id', s.advanced_custom_id_button );
            }
