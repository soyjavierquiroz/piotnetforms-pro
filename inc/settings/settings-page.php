...
function piotnetforms_generate_key($key){
    $new_key = '';
...
if ( isset( $_GET['post'] ) ) {
				...
				<div class='piotnetforms-navigator-widgets'></div>
					...
					$dynamic_tags = [
                        ...
                        'local_date_time' => [
							...
							'tag' => '{{local_date_time | date_format:Y-m-d H:i:s}}',
						],
						'shortcode' => [
							'text' => 'Shortcode',
	...
	<div class="piotnetforms-dashboard piotnetforms-dashboard--templates">
        ...
        $fontawesome = esc_attr( get_option( 'piotnetforms_disable_font_awesome' ) );
        ?>
                        <table class="form-table" style="margin-top: -20px;">
                            ...
                            <tr valign="top">
                                <th scope="row"><?php _e( 'Disable Font Awesome', 'piotnetforms' ); ?></th>
                                <td><input type="checkbox" name="piotnetforms_disable_font_awesome" value="yes" <?php if ( $fontawesome == 'yes' ) {
                                	echo 'checked';
                                }; ?>/></td>
                            </tr>
                            <tr valign="top">
